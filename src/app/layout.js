...
const APP_NAME = "1001anime";
const APP_DEFAULT_TITLE = "1001anime - The Ultimate Gateway to Watch Anime Online";
const APP_DESCRIPTION = "Explore a vast collection of anime on 1001anime, your go-to destination for streaming the latest and classic anime series. Immerse yourself in captivating storylines, vibrant animation, and diverse genres. Discover a world of entertainment at your fingertips with 1001anime, where every episode is an adventure.";

export const metadata = {
  metadataBase: new URL('https://1001anime.com'),
